# Google-Unternehmensprofil ACLA VIGLIA RADONS

> Stand: 23.09.2026 · Vorlage für das Profil (Geschäftscode 10056721609796961539, bestätigt).
> Bei jeder Text- oder Preisänderung auf der Website hier und im Profil nachziehen.
> Quelle der Fakten: `src/lib/content.ts` (Kanon der Website).

## Ist-Stand (gelesen 23.09.2026)

| Feld | Profil | Website | Status |
|------|--------|---------|--------|
| Name | ACLA VIGLIA RADONS | ACLA VIGLIA RADONS | identisch |
...
- **Zusätzliche Kategorie:** Ferienwohnung (falls «Ferienhaus» als Hauptkategorie bleibt).
- **Ausstattung (Hoteldetails):** WLAN, Haustiere erlaubt, Parkplatz (Sommer), Küche, Kamin.
- **Check-in / Check-out:** Samstag ab 15 Uhr / Samstag bis 10 Uhr.
- **Fotos:** Aussen Sommer und Winter, Wohnküche, Specksteinofen, Schlafzimmer, Umgebung. Dieselben Bilder wie auf `/galerie`, keine KI-Bilder.
- **Rezensionen:** Stammgäste nach dem Aufenthalt persönlich um eine Google-Bewertung bitten (Link über «Um Rezensionen bitten» im Profil). Nie kaufen.
